import { ClassDefinition, ConstDeclaration, FunctionDefinition, ModuleVarDecl, ObjectMethodDefinition, ResourceAccessorDefinition, ServiceDeclaration, STKindChecker, STNode, TypeDefinition, Visitor } from "@dharshi/syntax-tree";
...
export class FindConstructByIndexVisitor implements Visitor {
    ...
    beginVisitFunctionDefinition(node: FunctionDefinition, parent?: STNode): void {
        ...
        if (STKindChecker.isModulePart(parent as STNode)) {
