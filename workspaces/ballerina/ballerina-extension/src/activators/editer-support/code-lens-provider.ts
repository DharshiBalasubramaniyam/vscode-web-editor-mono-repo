...
import { ExecutorPosition, ExecutorPositionsResponse, SyntaxTree } from '@dharshi/ballerina-core';
import { traversNode } from '@dharshi/syntax-tree';
import { CodeLensProviderVisitor } from './codelense-provider-visitor';
import { BallerinaExtension, LANGUAGE } from '../../extension';
import { ExtendedLanguageClient } from 'src/extended-language-client';
...
export class ExecutorCodeLensProvider implements CodeLensProvider {
    ...
    private async getCodeLensList(): Promise<CodeLens[]> {
        ...
        let langClient: ExtendedLanguageClient | undefined = this.ballerinaExtension.langClient;
