import { Type, ServiceClassModel, ModelFromCodeRequest, FieldType, FunctionModel, NodePosition, STModification, removeStatement, LineRange, EVENT_TYPE } from "@dharshi/ballerina-core";
import { Button, Codicon, Typography, TextField, ProgressRing, Menu, MenuItem, Popover, Item, ThemeColors, LinkButton } from "@dharshi/ui-toolkit";
...
export function GraphqlObjectViewer(props: GraphqlObjectViewerProps) {
    const { onClose, type, filePath, onImplementation } = props;
